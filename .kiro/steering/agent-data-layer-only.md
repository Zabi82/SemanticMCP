...
**CRITICAL**: You must ONLY use the tools listed below. DO NOT use any semantic layer tools (list_metrics, get_metric_definition, list_dimensions, query_metric) even if they appear available.
